...
//  Having position:absolute  in two levels higher than the wordform fixed the scroll issue. Leave overflow-auto in the 
//  div one level high than position:absolute
